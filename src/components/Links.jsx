  ...
  return (
    <>
      ...
      <Flex gap={"5px"} padding={"5px"}>
        <Img src={dropodds}/>
        <Text fontSize={"20px"}>Dropping Odds</Text>
      </Flex>
      <Flex gap={"5px"} padding={"5px"}>
        <Img src={blockodds} />
        <Text fontSize={"20px"}>Blocked Odds</Text>
      </Flex>
      <Flex gap={"5px"} padding={"5px"}>
        <Img src={valuebets} />
        <Text fontSize={"20px"}>Value Bets</Text>
      </Flex>
      <Flex gap={"5px"} padding={"5px"}>
        <Img src={hotmatches} />
        <Text fontSize={"20px"}>Hot Matches</Text>
      </Flex>
      <Flex gap={"5px"} padding={"5px"}>
        <Img src={archive} />
        <Text fontSize={"20px"}>Archived Results</Text>
      </Flex>
      <Flex gap={"5px"} padding={"5px"}>
        <Img src={standings} />
        <Text fontSize={"20px"}>Standing</Text>
      </Flex>
    </>
  );
}
